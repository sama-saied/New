...
Route::get('/policy', 'Admin\SettingFollower@policy')->name('admin.settings.policy');
Route::get('/ourHistory', 'Admin\SettingFollower@history')->name('admin.settings.history');
Route::get('/delivery', 'Admin\SettingFollower@delivery')->name('admin.settings.delivery');
