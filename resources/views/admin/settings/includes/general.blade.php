...
<!--
    For each setting input block, we are prepopulating the value usinf config()
     helper of Laravel as our all settings are available globally. 
     You can also use the Config::get($key) or Setting::get($key) facades to get
      a getting value inside your view
-->